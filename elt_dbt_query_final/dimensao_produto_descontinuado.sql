...
select
	...
	case
		when ProductSubcategoryID is null and ProductCategoryID is null then (select cast(max(sellstartdate) as date) from stg_dim.stgproduct)
